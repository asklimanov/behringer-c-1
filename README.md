# Настройка микрофона Behringer C-1 (UM2)
...
* Уровень громкости аудиоинтерфейса в системе: 70<br>
* Ручка регулятора громкости входного сигнала (на карте): 75% (15 часов)<br>
...
3. Выбрать аудиоинтерфейс в качестве устройства ввода в Configuration Editor (самый первый фильтр)<br>r>
